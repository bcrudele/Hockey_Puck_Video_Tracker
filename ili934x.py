...
class ILI9341:
    ...
    def text(self, text, x, y, color, background=color565(0,0,0)):
        """
        Draw text on the display with specified color at (x, y) position.
        
        :param text: The text string to display.
        :param x: The x-coordinate for text position.
        :param y: The y-coordinate for text position.
        :param color: The color for the text (in 565 RGB format).
        """
        self.set_color(color, background)  # Use the same color for both foreground and background
        self.chars(text, x, y)
